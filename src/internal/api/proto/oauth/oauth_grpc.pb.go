...
const (
	OauthService_OAuth_FullMethodName = "/oauth.OauthService/OAuth"
)
...
type OauthServiceClient interface {
	OAuth(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Res, error)
}
...
func (c *oauthServiceClient) OAuth(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Res, error) {
	out := new(Res)
	err := c.cc.Invoke(ctx, OauthService_OAuth_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OauthServiceServer interface {
	OAuth(context.Context, *Req) (*Res, error)
...
func (UnimplementedOauthServiceServer) OAuth(context.Context, *Req) (*Res, error) {
...
func _OauthService_OAuth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Req)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OauthServiceServer).OAuth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OauthService_OAuth_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OauthServiceServer).OAuth(ctx, req.(*Req))
	}
...
var OauthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "OAuth",
			Handler:    _OauthService_OAuth_Handler,
		},
	},
